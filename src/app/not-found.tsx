...
export default function NotFound() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#edf2f6] px-4 py-10">
      <section className="relative w-full max-w-2xl overflow-hidden rounded-[28px] border border-slate-200 bg-white p-8 text-center shadow-sm md:p-12">
        ...
        <div className="relative z-10">
          ...
          <p className="mx-auto mt-4 max-w-xl text-sm leading-7 text-slate-500 md:text-base">
            The URL may be mistyped, moved, or unavailable. Let&apos;s get you
