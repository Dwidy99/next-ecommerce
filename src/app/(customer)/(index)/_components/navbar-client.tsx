...
function NavbarSearchForm() {
  return (
    <form
      action="/catalogs"
      className="hidden items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-white backdrop-blur xl:flex"
    >
      ...
      <input
        ...
        className="w-[180px] bg-transparent text-sm outline-none placeholder:text-white/60"
      />
    </form>
  );
}
